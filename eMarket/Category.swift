...
func createCategorySet() {
    let womanClothing = Category(_name: "Women's Clothing & Accessories", _imageName: "womenCloth")
    ...
    let menClothing = Category(_name: "Men's Clothing & Accesories", _imageName: "menCloth")
    ...
    let industry = Category(_name: "Pet products", _imageName: "pet")
    let garden = Category(_name: "Garden supplies", _imageName: "garden")
    let camera = Category(_name: "Camera & Optics", _imageName: "camera")
    
    let arrayOfCategories = [womanClothing,footWear,electronics,menClothing,health,baby,home,car,luggage,jewelery,hobby,pet,industry,garden,camera]
